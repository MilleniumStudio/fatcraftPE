...
//                ->start();
    ...
    public function transaction(Player $player, Item $itemPlayerSide, Item $itemChestSide)
    {
        echo "transaction " . $player->getName() . " " . $itemPlayerSide . " -> " . $itemChestSide . "\n";
        return new Item(Item::ACACIA_DOOR);
    }
