...
namespace fatcraft\loadbalancer\control_socket;
...
class RCON
{
    ...
    public function __construct(PluginBase $plugin, int $port = 19132, string $interface = "0.0.0.0", int $threads = 1, int $clientsPerThread = 50)
    {
        $this->plugin = $plugin;
